...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-sky-600 text-sky-50 shadow hover:bg-sky-700/80 dark:bg-sky-50 dark:text-sky-900 dark:hover:bg-sky-50/80",
        secondary:
          "border-transparent bg-lime-100 text-lime-900 hover:bg-lime-100/80 dark:bg-lime-800 dark:text-lime-50 dark:hover:bg-lime-800/80",
        destructive:
