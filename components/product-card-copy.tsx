  ...
  return (
    ...
    >
      <div className="w-full">
        ...
        <CardContent>
          <div className="group aspect-video relative mb-4 cursor-pointer hover:aspect-square transition-all duration-200 ease-in-out">
            <Image
              src={
                !image.includes('https')
                  ? imagePlaceHolder
              ...
              alt={name}
              fill
              className="object-contain group-hover:object-contain rounded-md border-neutral-200 border-2"
            />
          </div>
